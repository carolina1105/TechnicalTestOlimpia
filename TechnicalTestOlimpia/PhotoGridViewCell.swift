...
public class PhotoGridViewCell: UICollectionViewCell {
    ...
    private static let videoBadgeImage = UIImage(systemName: "play.rectangle.fill")
    private static let animatedBadgeImage = UIImage(systemName: "livephoto")
    private static let selectedBadgeImage =  UIImage(systemName: "checkmark.circle.fill")?.withRenderingMode(.alwaysTemplate)
    public var loadingColor = UIColor.nFourth
    ...
    var contentTypeBadgeImage: UIImage? {
        ...
        set {
            ...
            contentTypeBadgeView.tintColor = UIColor.nSecondaryText
        }
    }
